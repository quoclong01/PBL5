        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-sm-7" style="padding-left: 0px">
            <select class="form-control" name="catalog_id">
              ...
              <option value="<?php echo $value->id; ?>" style='font-weight: bold'
                <?php if($value->id==$catalog_id) echo 'selected'; ?>><?php echo $value->name; ?></option>
    ...
    <div class="form-group form-group-sm">
      ...
      <div class="col-sm-7" style="padding-left: 0px">
        <select class="form-control" name="price_from">
          ...
          <option value="<?php echo $i ?>" <?php if($i==$price_from) echo 'selected'; ?>>
            <?php echo number_format($i); ?> VNĐ</option>
          <?php } ?>
        </select>
      </div>
    </div>
    <div class="form-group form-group-sm">
      ...
      <div class="col-sm-7" style="padding-left: 0px">
        <select class="form-control" name="price_to">
          ...
          <option value="<?php echo $i ?>" <?php if($i==$price_to) echo 'selected'; ?>><?php echo number_format($i); ?>
            VNĐ</option>
          <?php } ?>
        </select>
      </div>
