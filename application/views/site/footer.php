  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="bank">
    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 no-padding">
      <div class="footer-info">
        ...
        <ul class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <h4><strong>DÀNH CHO NGƯỜI MUA</strong></a></h4>
          <li> <a href="#">Bảo vệ người mua</a></li>
          <li> <a href="#">Quy định đối với người mua</a></li>
          <li> <a href="#">Câu hỏi thường gặp</a></li>
          <li> <a href="#">Hưỡng dẫn mua hàng Online</a></li>
        </ul>
        <ul class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <h4><strong>DÀNH CHO NGƯỜI BÁN</strong></h4>
    ...
    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 footer-right">
