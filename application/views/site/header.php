<div class="row" style="margin-top: 8px;height: 110px">
  ...
  <!-- <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 clearpadding">
    <a href="#"><img style="max-height: 110px;width: 100%" src="<?php echo base_url(); ?>upload/banner.jpg" alt=""
        class="img-responsive"></a>
  </div> -->
</div>
<div class="row">
    ...
    <div class="container-fluid re-container-fluid">
      ...
      <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <?php foreach ($catalog as $value)
			           {
			            ...
			            ?>
              <li><a style="color: #337ab7;padding: 10px 20px;"
                  href="<?php echo base_url($name.'-c'.$value->id); ?>"><?php echo $value->name; ?></a></li>
              <?php } ?>
            </ul>
          </li>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
              aria-expanded="false">Xin chào: <?php echo $user->name; ?><span class="caret"></span></a>
